...
<script>
	...
	function contructGoodsHTML(ret, isinit){
		...
		for(var i = 0,len=result.length; i < len; i++){
			...
			LI += "<li><div class=\"product_info_pc\"><img src=\""+thumb+"\" style=\"float:right\"><p class=\"list_table_tit\">"+good.goods_name+"</p><p class=\"list_table_price\"><span>￥"+good.shop_price+"</span><b>"+mark_price+"</b></p></div></li>";
		}
