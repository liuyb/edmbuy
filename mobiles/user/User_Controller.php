...
class User_Controller extends MobileController {
  ...
  private $user_header_img_dir = '/a/user/header/';
  
  private $user_qrcode_img_dir = '/a/qrcode/item/';
    
  public function menu() {
    return [
      'user' => 'index',
      'user/setting' => 'user_setting',
      'user/header/upload' => 'upload_header',
  ...
  public function upload_header(Request $request, Response $response){
      if($request->is_post()) {
