...
<?php else: ?>
    ...
    <?php $leve = ['0'=>'无', '1' => '一级人脉', '2' => '二级人脉', '3' => '三级人脉']; ?>
    ...
    <div class="my_name_info">
        ...
        <?php if($level):?><div>人脉层级：<?=$leve[$level] ?></div><?php endif;?>
    ...
    <div class="income_nums">
        <span>共<?= $totalNumber ?>件商品</span><span class="income_nums_r">运费：<?=$userInfo['shipping_fee'] ?>&nbsp;&nbsp;&nbsp;&nbsp;合计：￥<?= $userInfo['money_paid'] ?></span>
    </div>
    <?php if ($is_user): ?>
