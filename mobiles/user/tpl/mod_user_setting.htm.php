...
<div style="background: #fff;">
	<div class="person_head_comment" style="border-top:0;">
		<span class="head_l_com">我的ID</span>
	...
	<div class="person_head_comment">
		...
		<span class="head_r_com" style="margin-right:12px;">
			<span><?=$role ?></span>
			<?php if(1 != $level): ?>
			<button class="personInfo_but" id="partner" style="font-size:13px;">成为米商</button>
			<?php endif;?>
		</span>
	</div>
	...
	<div class="person_head_comment">
		...
		<span class="head_r_com" style="margin-right:12px;">
			...
			<button class="personInfo_but per_add_friend" id="friend" style="font-size:14px;">加好友</button>
		</span>
	</div>
	<?php endif;?>
</div>
...
<?php require '/mobiles/user/include/add_as_friend.html';?>

<script>
//好友弹框
$(".personInfo_but").on("click",function(){
...
function fileupload(e){
    ...
    fr.onload = function(ev) {
    	...
    	F.post('/user/header/upload', {img:img}, function(ret){
    		if(ret.flag=='SUC'){
