...
<div class="white_bg">
	...
	<div class="order_info">
		<table cellspacing="0" cellpadding="0" class="order_info_tab">
			<tr>
				...
				<td class="info_td3">
					<p class="info_price" style="color:#f65d00;">￥<?=isset($packages['actual_price']) ?: $packages['actual_price'] ?></p>
					<p class="info_num" style="text-decoration: line-through;">￥<?=isset($packages['sale_price'])?: $packages['sale_price'] ?></p>	
				</td>
			</tr>
		</table>
	</div>
	...
	<div class="settle_price">
		总价：<span class="pro_price" style="color:#f65d00;">￥<?=sprintf('%.2f', isset($packages['sale_price'])?: $packages['sale_price']) ?></span>
	</div>
</div>
...
<script>
var pid = <?=isset($pack['pid'])?: $packages['pid'] ?>
