...
$(document).ready(function(){
	...
	//监听点击继续购买
	$("#goods_list").on('click','.pro_info_btn', function(){
...
function contructGoodsHTML(ret, isinit){
	...
	for(var i = 0,len=result.length; i < len; i++){
		...
		LI += "<li><div class=\"pro_info_l\"><img src=\"<?php echo ploadingimg()?>\" data-loaded=\"0\" onload=\"imgLazyLoad(this,'"+goodimg+"')\"></div>";
		...
		LI += "<p><button class=\"pro_info_btn\" data-goodid='"+good.goods_id+"'>立即购买</button></p>";
