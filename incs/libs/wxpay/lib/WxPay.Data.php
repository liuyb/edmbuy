...
class WxPayEnterprisePay extends WxPayDataBase
{
	 ...
	 * @var constant
	 */
	const CHECK_NAME_NO     = 'NO_CHECK';
	const CHECK_NAME_FORCE  = 'FORCE_CHECK';
	const CHECK_NAME_OPTION = 'OPTION_CHECK';
	...
	/**
	 * 设置校验用户姓名选项，可选项：NO_CHECK, FORCE_CHECK, OPTION_CHECK
	 * @param string $value
	 **/
...
class WxPayEnterpriseQuery extends WxPayDataBase
{
	/**
	 * 设置微信分配的公众账号ID
	 * @param string $value
