...
WHERE o.`pay_status`=2 AND o.`is_separate`=0 {$where} and o.order_flag <> 9  
...
WHERE o.`merchant_ids`='%s' AND o.`pay_status`=2 AND o.`is_separate`=0 {$where} and o.order_flag <> 9  
GROUP BY o.`order_id`
) AS a";
